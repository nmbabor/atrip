...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<!-- CS Select -->
	<link rel="stylesheet" href="{{asset('assets/frontend/css/cs-select.css')}}">
	<link rel="stylesheet" href="{{asset('assets/frontend/css/cs-skin-border.css')}}">
	...
	<script src="{{asset('assets/frontend/js/selectFx.js')}}"></script>
