...
@section('content')
    ...
    <div class="fh5co-hero">
        ...
        <div class="fh5co-cover" data-stellar-background-ratio="0.5"
            style="background-image: url({{ asset('frontend/images/cover_bg_1.jpg') }});">
            <div class="desc">
                <div class="container">
                    <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
                    <div href="{{url('pages/contact')}}"><img src="{{ asset('frontend/images/place-1.jpg') }}"
                ...
                <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
                    <div href="{{url('pages/contact')}}"><img src="{{ asset('frontend/images/place-2.jpg') }}"
                            alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
                        <div class="desc">
                            <span></span>
                            <h3>Philippines</h3>
                ...
                <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
                    <div href="{{url('pages/contact')}}"><img src="{{ asset('frontend/images/place-3.jpg') }}"
                            alt="Free HTML5 Website Template by FreeHTML5.co" class="img-responsive">
                        <div class="desc">
                            <span></span>
                            <h3>Hongkong</h3>
                ...
                <div class="col-md-12">
                    <ul id="fh5co-destination-list" class="animate-box">
                        <li class="one-forth text-center"
                            style="background-image: url({{ asset('frontend/images/place-1.jpg') }}); ">
                        ...
                        <li class="one-forth text-center"
                            style="background-image: url({{ asset('frontend/images/place-2.jpg') }}); ">
                            <a href="{{url('pages/contact')}}">
                                <div class="case-studies-summary">
                                    <h2>Hongkong</h2>
                                </div>
                        ...
                        <li class="one-forth text-center"
                            style="background-image: url({{ asset('frontend/images/place-3.jpg') }}); ">
                            <a href="{{url('pages/contact')}}">
                                <div class="case-studies-summary">
                                    <h2>Italy</h2>
                                </div>
                        ...
                        <li class="one-forth text-center"
                            style="background-image: url({{ asset('frontend/images/place-4.jpg') }}); ">
                            <a href="{{url('pages/contact')}}">
                                <div class="case-studies-summary">
                                    <h2>Philippines</h2>
                                </div>
                        ...
                        <li class="one-forth text-center"
                            style="background-image: url({{ asset('frontend/images/place-5.jpg') }}); ">
                            <a href="{{url('pages/contact')}}">
                                <div class="case-studies-summary">
                                    <h2>Japan</h2>
                                </div>
                        ...
                        <li class="one-forth text-center"
                            style="background-image: url({{ asset('frontend/images/place-6.jpg') }}); ">
                            <a href="{{url('pages/contact')}}">
                                <div class="case-studies-summary">
                                    <h2>Paris</h2>
                                </div>
                        ...
                        <li class="one-forth text-center"
                            style="background-image: url({{ asset('frontend/images/place-7.jpg') }}); ">
                            <a href="{{url('pages/contact')}}">
                                <div class="case-studies-summary">
                                    <h2>Singapore</h2>
                                </div>
                        ...
                        <li class="one-forth text-center"
                            style="background-image: url({{ asset('frontend/images/place-8.jpg') }}); ">
                            <a href="{{url('pages/contact')}}">
                                <div class="case-studies-summary">
                                    <h2>Madagascar</h2>
                                </div>
                        ...
                        <li class="one-forth text-center"
                            style="background-image: url({{ asset('frontend/images/place-9.jpg') }}); ">
                            <a href="{{url('pages/contact')}}">
                                <div class="case-studies-summary">
                                    <h2>Egypt</h2>
                                </div>
                        ...
                        <li class="one-forth text-center"
                            style="background-image: url({{ asset('frontend/images/place-10.jpg') }}); ">
                            <a href="{{url('pages/contact')}}">
                                <div class="case-studies-summary">
                                    <h2>Indonesia</h2>
                                </div>
